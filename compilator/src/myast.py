...
def translate_ast_to_c(ast, filename):
    ...
    c_code += f'    SDL_Texture* mainTexture = SDL_CreateTexture(renderer, SDL_PIXELFORMAT_RGBA8888, SDL_TEXTUREACCESS_TARGET, windowW, windowH);\n'
...
def execute_ast(ast, debug, filename):
    ...
    filename = os.path.join(script_dir, "../../.to_run.c")
    
    # Write the generated C code to the file
    with open(filename, 'w') as f:
        f.write(c_code)

    print(f"\033[32m\nGenerated C code successfully. Written to: {filename}\033[0m")
# @}